...
export default function Sidebar({
  ...
  return (
    <div style={{
      width: "260px", background: "#fff", borderRight: "1px solid #e8ecf5",
      ...
      <div>
        ...
        {ALGOS.map(a => (
          <button key={a.id} className="btn-act"
            onClick={() => { setAlgo(a.id); clearVisualization(); }}
            style={{
              ...
              textAlign: "left", marginBottom: "4px", fontFamily: "inherit", fontSize: "13px"
            }}>
